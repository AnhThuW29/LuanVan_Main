        ...
        <ScrollView>
          <>
            ...
            <CustomInput
              ...
              value={user.SDT}
              onChangeText={(text) => setUser({ ...user, SDT: text })}
            />
            <CustomInput
              placeholder="Ngày sinh"
              iconName="cake"
              value={user.NgaySinh}
              onChangeText={(text) => setUser({ ...user, NgaySinh: text })}
            />
            <CustomInput
            ...
            <CustomInput
              ...
              keyboardType="number-pad"
              value={user.CMND}
              onChangeText={(text) => setUser({ ...user, CMND: text })}
            />
            <CustomInput
              placeholder="Địa chỉ"
              iconName="home"
                  ...
                  DiaChi: [
                    {
                      ...
                      QuanHuyen: user.DiaChi[0].QuanHuyen,
                      XaPhuong: user.DiaChi[0].XaPhuong,
                      ChiTiet: text,
                    },
                  ],
                });
