...
>>>>>>> 9dce5133d1310f8069b75c2f84ac136b1a746fea
        ...
        <View style={styles.infoWrapper}>
          ...
          <View style={[styles.infoItemRightWrapper, { width: "80%" }]}>
            <Text
              style={[
                styles.infoItemText,
        ...
        <View style={styles.infoWrapper}>
          ...
          <View style={styles.infoItemRightWrapper}>
            <Text style={styles.infoItemText}>{post.NguoiHuongDan}</Text>
          </View>
        </View>
        ...
        <View style={styles.infoWrapper}>
          ...
          <View style={styles.infoItemRightWrapper}>
            <Text style={styles.infoItemText}>{dataKhachHang.HoTen}</Text>
          </View>
        </View>
        <View style={styles.infoWrapper}>
          <View style={styles.infoItemLeftWrapper}>
          ...
          <View style={styles.infoItemRightWrapper}>
            <Text style={styles.infoItemText}>{dataKhachHang.SDT}</Text>
          </View>
        </View>
        <View style={styles.infoWrapper}>
          <View style={styles.infoItemLeftWrapper}>
          ...
          <View style={styles.infoItemRightWrapper}>
            <Text style={styles.infoItemText}>{dataKhachHang.Email}</Text>
          </View>
        </View>
      </ScrollView>
      <View style={styles.footer}>
